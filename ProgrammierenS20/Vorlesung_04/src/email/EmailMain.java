...
public class EmailMain {
	...
	public static void main(String[] args) {
		...
		emails[14] = new Email("Zocken", "Hey Kristina, Lust auf ne Runde Spielen am Wochenende und Grillen im Stadtpark? Sag mal Bescheid, ob du dabei bist! LG");
		...
		emails[16] = new Email("Treffen", "Kauf Alohad,\nkommste nachher mit zum Slam? Wollen uns um 19 uhr treffen und dann was Essen gehen. Es geht dann um 20:30 Uhr los.\nCu Peter");
		emails[17] = new Email(" Bier brauen", " lol Hey Jan,\nSarah will mal Bier brauen, du musst dann wohl unter übel vorbei kommen zum kosten.\nBis denne\nSteve");
		emails[18] = new Email("Bla", "00:23:02 - Pizza bestellt");
		emails[19] = new Email("Bla", "23:59:15");

		//A...d
//		String regex = "H[aä]us(er)?";
		
//		String regex = "(\\s)[Aa][a-z]*[d](\\s)";
//		String regex = "(\\s|^)[Aa]\\w*[d](\\s|[.,?!:;])";
//		String regex = "(\\s)[Kk][a-z]*[a](\\s|[.,?!:;])"; //Kristina
//		String regex = "(\\s|^)[Ss][a-z]*[e](\\s|[.,?!:;])"; //Mit s oder S anfangen und mit e beenden
//		String regex = "(\\s)[AaKk][a-z]*[.?!]"; //Wort am Ende eines Satzes mit a-k & A-K als anfangsbuchtsabe
//		String regex = "(([0-1][0-9])|([2][0-3])):[0-5][0-9]:[0-5][0-9].*"; //. = beliebiges Zeichen; * = beliebig oft
		String regex="(\\s|^)[Ll](ol)";
		
		Pattern pattern = Pattern.compile(regex);
		for(Email email : emails) {
			// Matcher versucht was wir finden wollen zu matchen, zu finden
